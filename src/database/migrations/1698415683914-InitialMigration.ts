...
export class InitialMigration1698415683914 implements MigrationInterface {
    name = 'InitialMigration1698415683914'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "onboarding_step" ADD CONSTRAINT "FK_021b04c275fa1963d765c36c993" FOREIGN KEY ("createdById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "onboarding_step" ADD CONSTRAINT "FK_157bc9b6ea1f87c17ffd38a2e45" FOREIGN KEY ("updatedById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "onboarding" ADD CONSTRAINT "FK_8a1e0db1e6a16db27197d6ed3cc" FOREIGN KEY ("formId") REFERENCES "form"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "onboarding" ADD CONSTRAINT "FK_5d829aaeb052ae45fd4386245cd" FOREIGN KEY ("createdById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "onboarding" ADD CONSTRAINT "FK_a425a79e547f53852fecb38029f" FOREIGN KEY ("updatedById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "form" ADD CONSTRAINT "FK_e09b89bec04563ca2090620c9b8" FOREIGN KEY ("createdById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "form" ADD CONSTRAINT "FK_2f59b3364cd5979b5bdb0b04a2e" FOREIGN KEY ("updatedById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "policy" ADD CONSTRAINT "FK_e2a559dc71c48a5f3514b2e91c3" FOREIGN KEY ("createdById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "policy" ADD CONSTRAINT "FK_9957126451c96dc1b7b24a34adc" FOREIGN KEY ("updatedById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "study" ADD CONSTRAINT "FK_9fd18fb2cef18a5495db7f5b5d3" FOREIGN KEY ("onboardingId") REFERENCES "onboarding"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "study" ADD CONSTRAINT "FK_0d7e9974f29b41c7d6f71e18c35" FOREIGN KEY ("formId") REFERENCES "form"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "study" ADD CONSTRAINT "FK_01679ee01ea9f9b1d9d9b6ad790" FOREIGN KEY ("createdById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "study" ADD CONSTRAINT "FK_3b87d8181be468dd85b21af815a" FOREIGN KEY ("updatedById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "country_code" ADD CONSTRAINT "FK_a3f647921b7ce7ba68dec258bb7" FOREIGN KEY ("createdById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "country_code" ADD CONSTRAINT "FK_9f556814e7dad8792d8301d00f9" FOREIGN KEY ("updatedById") REFERENCES "api_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "onboarding_steps_onboarding_step" ADD CONSTRAINT "FK_ca7c49c6f5c1c011e542d3a9d82" FOREIGN KEY ("onboardingId") REFERENCES "onboarding"("id") ON DELETE NO ACTION ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "onboarding_steps_onboarding_step" ADD CONSTRAINT "FK_a970c7645870f36dff75a36834b" FOREIGN KEY ("onboardingStepId") REFERENCES "onboarding_step"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "study_country_codes_country_code" ADD CONSTRAINT "FK_4cfb59aaf5b2a9569d7870b4e0b" FOREIGN KEY ("studyId") REFERENCES "study"("id") ON DELETE NO ACTION ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "study_country_codes_country_code" ADD CONSTRAINT "FK_1bbd7a5ca5487401312dbc3c64e" FOREIGN KEY ("countryCodeId") REFERENCES "country_code"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "study_policies_policy" ADD CONSTRAINT "FK_af78054ab5470ed0b9bd86e2b1f" FOREIGN KEY ("studyId") REFERENCES "study"("id") ON DELETE NO ACTION ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "study_policies_policy" ADD CONSTRAINT "FK_d10bca86457cc7127c730c63a0d" FOREIGN KEY ("policyId") REFERENCES "policy"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
